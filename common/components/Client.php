...
include 'mongodb\mongodb\Database.php';
use Yii;
...
use common\components\mongodb\Model\DatabaseInfoIterator;
use common\components\mongodb\Operation\DropDatabase;
use common\components\mongodb\Operation\ListDatabases;
// https://github.com/mongodb/mongo-php-library
// http://php.net/manual/en/book.mongo.php
class Client
{
    private static $defaultTypeMap = [
        'array' => 'common\components\mongodb\model\BSONArray',
        'document' => 'common\components\mongodb\model\BSONDocument',
        'root' => 'common\components\mongodb\model\BSONDocument',
    ];
    ...
    {
        $uri = $connectOptions['dsn'];
        $uriOptions = $connectOptions['uriOptions'];
        $driverOptions = $connectOptions['driverOptions'];

        if(!$driverOptions['typeMap']){
        ...
        $this->nameDatabase = (isset($connectOptions['nameDatabase'])) ? $connectOptions['nameDatabase'] : false;
     ...
     * @return Collection
     */
    public function selectCollection($collectionName, $databaseName = false, array $options = [])
    {
        if(!$databaseName){
            $databaseName = ($this->nameDatabase) ? $this->nameDatabase : false;
        }
