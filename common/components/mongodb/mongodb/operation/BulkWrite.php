...
use common\components\mongodb\BulkWriteResult;
        ...
        foreach ($operations as $i => $operation) {
            ...
            switch ($type) {
                ...
                case self::REPLACE_ONE:
                    ...
                    if (\common\components\mongodb\is_first_key_operator($args[1])) {
            ...
            switch ($type) {
                ...
                case self::INSERT_ONE:
                    ...
                    if ($insertedId !== null) {
                        ...
                        $insertedIds[$i] = \common\components\mongodb\extract_id_from_inserted_document($args[0]);
                    }
