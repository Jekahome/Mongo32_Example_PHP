...
use common\components\mongodb\Model\IndexInfoIteratorIterator;
use EmptyIterator;
...
class ListIndexes implements Executable
{
    ...
    {
        return \common\components\mongodb\server_supports_feature($server, self::$wireVersionForCommand)
