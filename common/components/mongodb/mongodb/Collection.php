...
namespace common\components\mongodb;
...
use common\components\mongodb\Exception\InvalidArgumentException;
use common\components\mongodb\Model\IndexInfoIterator;
use common\components\mongodb\Model\IndexInput;
use common\components\mongodb\Operation\Aggregate;
use common\components\mongodb\Operation\BulkWrite;
use common\components\mongodb\Operation\CreateIndexes;
use common\components\mongodb\Operation\Count;
use common\components\mongodb\Operation\DeleteMany;
use common\components\mongodb\Operation\DeleteOne;
use common\components\mongodb\Operation\Distinct;
use common\components\mongodb\Operation\DropCollection;
use common\components\mongodb\Operation\DropIndexes;
use common\components\mongodb\Operation\Find;
use common\components\mongodb\Operation\FindOne;
use common\components\mongodb\Operation\FindOneAndDelete;
use common\components\mongodb\Operation\FindOneAndReplace;
use common\components\mongodb\Operation\FindOneAndUpdate;
use common\components\mongodb\Operation\InsertMany;
use common\components\mongodb\Operation\InsertOne;
use common\components\mongodb\Operation\ListIndexes;
use common\components\mongodb\Operation\ReplaceOne;
use common\components\mongodb\Operation\UpdateMany;
use common\components\mongodb\Operation\UpdateOne;
use Traversable;
...
class Collection
{
    private static $defaultTypeMap = [
        'array' => 'frontend\component\model\BSONArray',
        'document' => 'frontend\component\model\BSONDocument',
        'root' => 'frontend\component\model\BSONDocument',
    ];
    ...
    {
        $hasOutStage = \common\components\mongodb\is_last_pipeline_operator_out($pipeline);
    ...
    public function findOneAndDelete($filter, array $options = [])
    {
        ...
        if ( ! isset($options['writeConcern']) && \common\components\mongodb\server_supports_feature($server, self::$wireVersionForFindAndModifyWriteConcern)) {
            $options['writeConcern'] = $this->writeConcern;
        }
